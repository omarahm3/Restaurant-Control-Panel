		...
		<div class="row">
			<div class="col-md-offset-2 col-md-8 col-sm-12 text-center">
				...
				<?php
					...
					if(isset($_FILES['fileToUpload']) && $_FILES['fileToUpload']['error'] == 0 && isset($_POST['name']) && isset($_POST['price']) && isset($_POST['details']) && isset($_POST['time']) && isset($_POST['sale']) ){
						...
						if(move_uploaded_file($_FILES['fileToUpload']['tmp_name'], 'uploads/'.$_FILES['fileToUpload']['name'])){
							if ($type == "drink")
								$db->createNewDrinkItem($name, $price, $details, $sale, $time, $path);
							
							else 
								$db->createNewFoodItem($name, $price, $details, $sale, $time, $path);
							echo '<h1 class="heading">Item has been ADDED!</h1>
								<hr>';
						}
					
					}
					else {
						echo '<h1 class="heading">Item has NOT been added!</h1>
								<hr>';
					}
