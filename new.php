	...
	<div class="container">
		<div class="row">
			<div class="col-md-offset-2 col-md-8 col-sm-12 text-center">
				...
				<form action="doneAdd.php" method="POST" enctype="multipart/form-data">

					<input type="radio" name="itemType" value="drink"> Drink<br>
  					<input type="radio" name="itemType" value="food"> Food<br>

					Name:   <input type="text" name="name" id="inputField" /></br>
					Price:   <input type="text" name="price" id="inputField" /></br>
					Details: <input type="text" name="details" id="textboxid" /></br>
					Time:   <input type="text" name="time" id="inputField" /> </br>
